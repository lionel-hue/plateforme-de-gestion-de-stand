...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item ms-lg-3">
                        <a class="btn btn-outline-danger" href="{{ route('visiteur.register') }}">S'inscrire</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class="hero-section">
        <div class="container">
            <h1 class="hero-title animate__animated animate__fadeInDown">Connectez-vous</h1>
            <p class="hero-subtitle animate__animated animate__fadeIn animate__delay-1s">
                Accédez à votre compte pour réserver vos plats préférés et profiter d'offres exclusives
            </p>
        </div>
    </section>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="login-card">
                        <div class="card-header">
                            <h3 class="card-title">Connexion Utilisateur</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <form id="login-form">
                                ...
                                <div class="d-flex justify-content-between mb-4">
                                    ...
                                    <div>
                                        <a href="#" class="register-link">Mot de passe oublié ?</a>
                                    </div>
                                </div>
                                ...
                                <div class="text-center pt-3 border-top">
                                    <p class="mb-0">
                                        ...
                                        <a href="{{ route('visiteur.register') }}" class="register-link">Inscrivez-vous ici</a>
                                    </p>
                                </div>
                            </form>
                        </div>
